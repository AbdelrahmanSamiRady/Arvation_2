...
export const Button = ({ as: As='button', className='', children, ...props }) => (
  <As className={`inline-flex items-center justify-center rounded-2xl px-4 py-2 text-sm font-medium bg-slate-900 text-white hover:opacity-95 disabled:opacity-50 disabled:cursor-not-allowed ${className}`} {...props}>{children}</As>
);
...
export const Input = ({ className='', ...props }) => (
  <input className={`h-10 rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-950 px-3 text-sm outline-none focus:ring-2 focus:ring-slate-300 ${className}`} {...props} />
);
export const Textarea = ({ className='', ...props }) => (
  <textarea className={`rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-950 px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-slate-300 ${className}`} {...props} />
);
