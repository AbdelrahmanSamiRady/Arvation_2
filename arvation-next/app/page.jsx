        ...
        <div className="mx-auto max-w-7xl px-6 py-16 md:py-24 grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              {services.map((s) => (
                <Badge key={s.label} variant="secondary" className="px-3 py-1 text-sm rounded-full">{s.label}</Badge>
              ))}
            </div>
            ...
            <Card key={label} className="border-slate-200 dark:border-slate-800">
              ...
              <CardContent className="pt-0">
                <ul className="text-sm text-slate-600 dark:text-slate-300 leading-relaxed list-disc pl-5">
                  ...
                  {label === "Backend" && (<><li>Node.js, Python, REST/GraphQL</li><li>AWS, serverless, containers</li><li>Auth, payments, multi‑tenant SaaS</li></>)}
                </ul>
              </CardContent>
            </Card>
          ))}
